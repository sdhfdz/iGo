...
public class AdpConfirmedOrder extends BaseAdapter implements View.OnClickListener{
    ...
    public AdpConfirmedOrder(List<OrderMessageModel> list, Context context) {
        this.list = list;
...
//            System.out.println(countInt);
    ...
    private void init(ViewHolder holder, View convertView, int position) {
        ...
        holder.orderVolum.setText(orderMessageModel.getOrderVolum());
    ...
    public interface DataListener{
        void dataUpdate(List<OrderMessageModel> list);
