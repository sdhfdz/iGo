    ...
    public void init() {
        ...
        setting_info_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (PrefUtils.getValidation(SettingAllActivity.this).length()>1){
                    ...
                    Toast.makeText(SettingAllActivity.this,"登陆后才能设置查看个人资料哦",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(SettingAllActivity.this,LoginActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
                    finish();
